...
(function ($) {
    $.fn.easyPaginate = function (options) {
        var defaults = {
            ...
            slideOffset: 200,
            firstButton: true,
            firstButtonText: "<i class='fa fa-angle-double-left fa-lg fa-fw'></i>",
            lastButton: true,
            lastButtonText: "<i class='fa fa-angle-double-right fa-lg fa-fw'></i>",
            prevButton: true,
            prevButtonText: "<i class='fa fa-angle-left fa-lg fa-fw'></i>",
            nextButton: true,
            nextButtonText: "<i class='fa fa-angle-right fa-lg fa-fw'></i>"
        }
