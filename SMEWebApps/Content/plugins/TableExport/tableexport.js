...
; (function (root, factory) {
    ...
    var TableExport = function (selectors, options, isUpdate) {
            ...
            self.settings.formats.forEach(
                function (key) {
                    ...
                    //!XLSX && key === 'xlsx' ? key = null : false;
                     dataXls = key && exporters[key](rowD, fileName);
                }
            );
            //exporters[xls](rowD, fileName)
            /**
        ...
        //function Export()
        //{
        //    var exporttbl=  exporters["xls"];
        //    var    data = object.data;
        //    var fileName = object.fileName;
        //    var  mimeType = object.mimeType;
        //    var    fileExtension = object.fileExtension;
        //    TableExport.prototype.export2file(data, mimeType, fileName, fileExtension);
        //}
        return self;
    };
